        ...
        <>
         <footer>
            ...
            <div className="footer-icons">
                <div className='footer-icon'><img src="../public/images/icon-facebook.svg" alt="footer-icons" className='footer-icons--image' /></div>
                <div className='footer-icon'><img src="../public/images/icon-twitter.svg" alt="footer-icons" className='footer-icons--image' /></div>
